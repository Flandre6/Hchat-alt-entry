...
object MonetModuleGenerator {
    fun generate(request: MonetGenerationRequest, listener: MonetGenerationListener): MonetGenerationResult {
        ...
        build(
            "HchatMonetWeChat.apk",
            "hchat.monet.com.tencent.mm",
            1,
            colors,
            baseDrawables,
        )
        when (request.options.bubbleStyle) {
            ...
            MonetBubbleStyle.CLASSIC -> build(
                "HchatMonetWeChatClassicBubble.apk",
                "hchat.monet.classicbubble.com.tencent.mm",
                10,
                drawables = MonetCustomOverlays.classicBubbles(resolved, palette),
            )
            MonetBubbleStyle.PRO -> build(
                "HchatMonetWeChatBubblePro.apk",
                "hchat.monet.bubblepro.com.tencent.mm",
                20,
        ...
        if (request.options.multiSceneCorners) {
            build(
                "HchatMonetWeChatMultiSceneCorners.apk",
                "hchat.monet.multiscenecorners.com.tencent.mm",
                30,
        ...
        build(
            "HchatMonetWeChatSolidTab.apk",
            "hchat.monet.solidtab.com.tencent.mm",
            10,
        ...
        build(
            "HchatMonetWeChatBlurTab.apk",
            "hchat.monet.blurtab.com.tencent.mm",
            10,
        ...
        return MonetGenerationResult(request.outputZip, colors.size, overlays.size)
    }
