...
import h.Hchat.hooks.items.monetgenerator.engine.MonetOverlayApkWriter.DrawableTarget
import h.Hchat.hooks.items.monetgenerator.engine.MonetOverlayApkWriter.XmlAttribute
import h.Hchat.hooks.items.monetgenerator.engine.MonetOverlayApkWriter.XmlNode
import h.Hchat.hooks.items.monetgenerator.engine.MonetOverlayApkWriter.XmlValue
...
object MonetCustomOverlays {
    ...
    fun themedIcon(
        ...
        val adaptive = XmlNode(
            "adaptive-icon",
            children = listOf(
                XmlNode("background", listOf(android("drawable", ATTR_DRAWABLE, XmlValue.NamedReference("drawable", "hchat_icon_bg")))),
                XmlNode("foreground", listOf(android("drawable", ATTR_DRAWABLE, XmlValue.NamedReference("drawable", "hchat_icon_fg")))),
                XmlNode("monochrome", listOf(android("drawable", ATTR_DRAWABLE, XmlValue.NamedReference("drawable", "hchat_icon_mono")))),
            ),
        )
        return listOf(
            DrawableTarget("hchat_icon_bg", solid(0xfff4fbf5.toInt()), solid(palette.surfaceDark)),
            DrawableTarget("hchat_icon_fg", foregroundIcon()),
            DrawableTarget("hchat_icon_mono", monochromeIcon()),
